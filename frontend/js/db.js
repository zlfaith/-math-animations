            ...
            if (chapters.length === 0) {
                const defaultChapterData = {
                    "初一": {
                        ...
                        "下册": [
                            { id: "1-2-1", name: "第七章 相交线与平行线" },
                            { id: "1-2-2", name: "第八章 实数" },
                            { id: "1-2-3", name: "第九章 平面直角坐标系" },
                            { id: "1-2-4", name: "第十章 二元一次方程组" },
                            { id: "1-2-5", name: "第十一章 不等式与不等式组" },
                            { id: "1-2-6", name: "综合与实践 低碳生活" },
                            { id: "1-2-7", name: "第十二章 数据的收集、整理与描述" }
                        ]
                    },
                    "初二": {
                        "上册": [
                            { id: "2-1-1", name: "第十三章 三角形" },
                            { id: "2-1-2", name: "综合与实践 确定匀质薄板的重心位置" },
                            { id: "2-1-3", name: "第十四章 全等三角形" },
                            { id: "2-1-4", name: "第十五章 轴对称" },
                            { id: "2-1-5", name: "综合与实践 最短路径问题" },
                            { id: "2-1-6", name: "第十六章 整式的乘法" },
                            { id: "2-1-7", name: "第十七章 因式分解" },
                            { id: "2-1-8", name: "第十八章 分式" }
                        ],
                        "下册": [
                            { id: "2-2-1", name: "第十九章 二次根式" },
                            { id: "2-2-2", name: "第二十章 勾股定理" },
                            { id: "2-2-3", name: "第二十一章 四边形" },
                            { id: "2-2-4", name: "第二十二章 函数" },
                            { id: "2-2-5", name: "第二十三章 一次函数" },
                            { id: "2-2-6", name: "综合与实践 音乐与数学" },
                            { id: "2-2-7", name: "第二十四章 数据的分析" }
                        ]
                    },
                    "初三": {
                        "上册": [
                ...
                console.log('默认章节数据已初始化');
            } else {
                console.log('章节数据已存在，跳过初始化');
            }
