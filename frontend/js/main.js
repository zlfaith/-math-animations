...
function buildDefaultChapterData() {
    return {
        "初一": {
            ...
            "下册": [
                { id: "1-2-5", name: "第五章 相交线与平行线" },
                { id: "1-2-6", name: "第六章 实数" },
                { id: "1-2-7", name: "第七章 平面直角坐标系" },
                { id: "1-2-8", name: "第八章 二元一次方程组" },
                { id: "1-2-9", name: "第九章 不等式与不等式组" },
                { id: "1-2-10", name: "第十章 数据的收集、整理与描述" }
            ]
        },
        "初二": {
            "上册": [
                { id: "2-1-11", name: "第十一章 三角形" },
                { id: "2-1-12", name: "第十二章 全等三角形" },
                { id: "2-1-13", name: "第十三章 轴对称" },
                { id: "2-1-14", name: "第十四章 整式的乘法与因式分解" },
                { id: "2-1-15", name: "第十五章 分式" }
            ],
            "下册": [
                { id: "2-2-16", name: "第十六章 二次根式" },
                { id: "2-2-17", name: "第十七章 勾股定理" },
                { id: "2-2-18", name: "第十八章 平行四边形" },
                { id: "2-2-19", name: "第十九章 一次函数" },
                { id: "2-2-20", name: "第二十章 数据的分析" }
            ]
        },
        "初三": {
            "上册": [
